...
(function () {
  ...
  ChatWidget.prototype.mount = function (container, opts) {
    ...
    this.fab = el("button", { id: "adz-chat-fab", "aria-label": "Chat to book with Rahul", html: AVATAR_SVG });
    ...
    var head = el("div", { id: "adz-chat-head" }, [
      ...
      el("div", {}, [
        el("b", { html: "Rahul" }),
        el("span", { html: "<i></i> Booking Assistant · online" })
      ]),
      (function () {
  ...
  ChatWidget.prototype.showTooltip = function () {
    ...
    tip.textContent = "💬 Book with me — no forms!";
  ...
  ChatWidget.prototype.runStep = function (step) {
    ...
    if (step === "intro") {
      this.addBot("Namaste 🙏 I'm <b>Rahul</b> from Apna Digital Zone. I can check availability and start your booking right here — no forms. What are you celebrating?", function () {
